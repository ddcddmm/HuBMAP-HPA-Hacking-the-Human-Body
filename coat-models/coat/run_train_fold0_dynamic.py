...
exp_name = 'coat0917_dynamic_1m1_stainv2'
FOLD = 0
BATCH_SIZE = 16
LR = 1e-4
# DEVICE_IDS = [0, 1]
...
#https://vcl.ucsd.edu/coat/pretrained/coat_small_7479cf9b.pth
	...
	while iteration < num_iteration:
		for t, batch in enumerate(train_loader):
			...
			if 1:
				...
				optimizer.zero_grad()
				scaler.scale(loss0+0.1*loss_0+0.2*loss_1+0.2*loss_2+0.2*loss_3).backward()
